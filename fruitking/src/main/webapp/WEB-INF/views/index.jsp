...
.flexslider li h1, .flexslider li h2, .flexslider li .category p,
	.flexslider li .category span {
...
.flexslider li.flex-active-slide .meta h1, .flexslider li.flex-active-slide .meta h2,
	.flexslider li.flex-active-slide .meta .category p, .flexslider li.flex-active-slide .meta .category span
	{
...
<body>
	...
	<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		<div id="tabmenu" class="navbar-nav">
			...
			<br> <a id="tablinks" class="nav-item nav-link" href="logout">로그아웃</a>
			<%
				} else {
			%>
	...
	<div id="floatMenu">
		<a href="http://www.customs.go.kr/kcshome/index.jsp" target="_blank"><img
			src="img/kcs.png" /></a><br> <a
			href="https://www.kamis.or.kr/customer/main/main.do" target="_blank"><img

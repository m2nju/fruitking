package kr.ac.hongik.fruitking.jdbc;
...
public class DBCPInit extends HttpServlet {
	...
	private void initConnectionPool() {
		try {
			String jdbcUrl = "jdbc:mysql://fruitking.czxyyplvdfua.us-east-2.rds.amazonaws.com/fruitking?useUnicode=true&characterEncoding=utf8";
			String userName = "master";
			String password = "passwords";
			
			// 커넥션팩토리 생성. 커넥션 팩토리는 새로운 커넥션을 생성할 때 사용한다.
			...
			// 위에서 커넥션 풀 드라이버에 생성한 커넥션 풀을 등록한다. 이름은 cp이다.
